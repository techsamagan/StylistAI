...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#17120E] text-white font-display overflow-x-hidden selection:bg-primary/20">

      {/* ── Navbar ───────────────────────────────── */}
      <header className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-[#17120E]/95 backdrop-blur-md border-b border-[#33291F] py-3' : 'bg-transparent py-5'}`}>
        <div className="max-w-6xl mx-auto px-6 flex items-center justify-between">
          ...
          >
            ...
            <span className="font-serif text-lg tracking-[0.2em] uppercase">ASANUR</span>
          </button>
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <button
              ...
              className="bg-primary text-[#17120E] px-4 py-2 rounded-xl text-sm font-bold hover:bg-primary/90 transition-all active:scale-[.97] shadow-lg shadow-primary/20"
            >
              Get Started
            </button>
          </div>
        ...
        {mobileNav && (
          <div className="absolute top-full left-0 w-full bg-[#17120E] border-b border-[#33291F] p-5 flex flex-col gap-3 md:hidden animate-fade-in">
            ...
            <hr className="border-[#33291F]" />
            <button onClick={() => navigate('/register')} className="bg-primary text-[#17120E] py-3 rounded-xl font-bold">
              Get Started
            </button>
          </div>
        )}
      ...
      <section className="pt-36 pb-24 px-6 max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        <div className="space-y-6">
          ...
          <div className={`flex flex-col sm:flex-row gap-3 pt-1 ${mounted ? 'animate-fade-up delay-300' : 'opacity-0'}`}>
            <button
              onClick={() => navigate('/register')}
              className="bg-primary text-[#17120E] px-7 py-3.5 rounded-xl font-bold text-sm flex items-center justify-center gap-2 hover:bg-primary/90 hover:shadow-xl hover:shadow-primary/20 transition-all active:scale-[.97]"
            >
              Build Your Closet
            ...
            <button
              ...
              className="border border-[#33291F] text-slate-300 px-7 py-3.5 rounded-xl font-medium text-sm flex items-center justify-center gap-2 hover:border-[#43372A] hover:bg-white/3 hover:text-white transition-all"
            >
              See it in action
            </button>
          </div>
          ...
          <div className={`flex items-center gap-3 pt-2 ${mounted ? 'animate-fade-up delay-400' : 'opacity-0'}`}>
            <div className="flex -space-x-2">
              {['#B7A98F','#8C8175','#D8C9AC','#6E6358'].map(c => (
                <div key={c} className="size-7 rounded-full border-2 border-[#17120E]" style={{ background: c }} />
              ))}
            </div>
        ...
        <div className={`hidden lg:block ${mounted ? 'animate-fade-up delay-300' : 'opacity-0'}`}>
          <div className="relative">
            <div className="bg-[#1E1813] border border-[#33291F] rounded-2xl overflow-hidden shadow-2xl shadow-black/40 animate-float">
              <div className="h-64 bg-[#13100C] overflow-hidden">
                <img
              ...
              <div className="p-6">
                ...
                <div className="flex gap-2 mb-4">
                  <span className="flex items-center gap-1 text-xs text-slate-400 bg-white/5 px-2.5 py-1 rounded-lg border border-[#33291F]">
                ...
                {['Waterproof Trench', 'Oxford Shirt', 'Dark Chinos'].map(item => (
                  <div key={item} className="flex items-center justify-between py-1.5 border-b border-[#33291F] last:border-0">
            ...
            {/* Floating badge */}
            <div className="absolute -bottom-4 -left-6 bg-[#1E1813] border border-[#33291F] p-3.5 rounded-xl shadow-xl animate-fade-up delay-500">
      ...
      {/* ── How it works ─────────────────────────── */}
      <section id="how" className="py-24 border-y border-[#33291F]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-14">
            <span className="text-xs font-bold text-primary uppercase tracking-widest">Process</span>
            <h2 className="text-4xl font-serif font-light text-white mt-2 mb-3">It starts with your closet.</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={step} className="bg-[#1E1813] border border-[#33291F] p-7 rounded-2xl hover:border-primary/20 transition-colors group">
                ...
                {img ? (
                  <div className="h-36 bg-[#17120E] rounded-xl overflow-hidden">
                    <img src={img} alt={title} className="w-full h-full object-cover opacity-70 group-hover:opacity-90 transition-opacity" />
                  </div>
                ) : (
                  <div className="h-36 bg-[#17120E] rounded-xl border border-dashed border-[#33291F] flex items-center justify-center">
      ...
      <section id="demo" className="py-24 max-w-6xl mx-auto px-6">
        <div className="text-center mb-14">
          ...
          <h2 className="text-4xl font-serif font-light text-white mt-2 mb-3">See how it thinks.</h2>
          <p className="text-slate-400">Change the inputs and watch ASANUR adapt instantly.</p>
        </div>

        <div className="bg-[#1E1813] border border-[#33291F] rounded-2xl p-7 md:p-10 grid lg:grid-cols-5 gap-8">
          {/* Controls */}
                  ...
                  <button
                    ...
                    className={`flex flex-col items-center gap-1.5 py-3 rounded-xl border transition-all ${
                      weather === id
                        ...
                        : 'bg-[#17120E] border-[#33291F] text-slate-500 hover:text-slate-300 hover:border-[#43372A]'
                    }`}
                  >
                ...
                {[
                  ...
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl border text-sm font-medium transition-all ${
                      occasion === id
                        ? 'bg-primary/10 border-primary/30 text-primary'
                        : 'bg-[#17120E] border-[#33291F] text-slate-400 hover:text-white hover:border-[#43372A]'
                    }`}
                  >
                    <span className="material-symbols-outlined text-[18px]">{icon}</span>
                    {label}
          ...
          {/* Result */}
          <div className="lg:col-span-3 bg-[#17120E] rounded-xl border border-[#33291F] overflow-hidden animate-fade-up" key={`${weather}-${occasion}`}>
            <div className="p-5 border-b border-[#33291F]">
              <span className="text-[9px] font-bold bg-primary text-[#17120E] px-2 py-0.5 rounded-md">AI SUGGESTION</span>
            ...
            <div className="p-4 space-y-2">
              {demo.items.map((item, i) => (
                <div key={item} className="flex items-center justify-between px-3 py-2.5 bg-[#1E1813] rounded-lg border border-[#33291F] animate-fade-up" style={{ animationDelay: `${i * 80}ms` }}>
      ...
      {/* ── Pricing ───────────────────────────────── */}
      <section id="pricing" className="py-24 border-t border-[#33291F]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            <span className="text-xs font-bold text-primary uppercase tracking-widest">Pricing</span>
            <h2 className="text-4xl font-serif font-light text-white mt-2 mb-3">Simple, transparent pricing.</h2>
            <div className="inline-flex bg-[#1E1813] border border-[#33291F] p-1 rounded-full mt-4">
              <button onClick={() => setAnnual(false)} className={`px-5 py-1.5 rounded-full text-xs font-bold transition-all ${!annual ? 'bg-primary text-[#17120E]' : 'text-slate-500 hover:text-white'}`}>Monthly</button>
              <button onClick={() => setAnnual(true)}  className={`px-5 py-1.5 rounded-full text-xs font-bold transition-all ${annual  ? 'bg-primary text-[#17120E]' : 'text-slate-500 hover:text-white'}`}>Yearly <span className="opacity-70 text-[9px]">−20%</span></button>
            </div>
          </div>
              ...
              <div
                ...
                className={`relative flex flex-col p-7 rounded-2xl border transition-colors ${
                  highlight
                    ...
                    : 'bg-[#1E1813] border-[#33291F] hover:border-[#43372A]'
                }`}
              >
                {badge && (
                  <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-primary text-[#17120E] text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wide whitespace-nowrap">
                    {badge}
                  </div>
                )}
                <div className="mb-5">
                ...
                <button
                  ...
                  className={`w-full py-2.5 rounded-xl text-sm font-bold transition-all active:scale-[.97] ${
                    highlight
                      ? 'bg-primary text-[#17120E] hover:bg-primary/90 shadow-lg shadow-primary/20'
                      : 'border border-[#43372A] text-slate-300 hover:bg-white/5 hover:text-white'
                  }`}
                >
                  {cta}
                </button>
      ...
      <section className="py-24 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <div className="bg-[#1E1813] border border-[#33291F] rounded-2xl p-12 relative overflow-hidden">
            ...
            <div className="relative">
              <h2 className="text-4xl font-serif font-light text-white mb-4">Ready to get dressed smarter?</h2>
              ...
              <button
                onClick={() => navigate('/register')}
                className="bg-primary text-[#17120E] px-8 py-3.5 rounded-xl font-bold text-sm hover:bg-primary/90 hover:shadow-xl hover:shadow-primary/20 transition-all active:scale-[.97]"
              >
      ...
      {/* ── Footer ──────────────────────────────── */}
      <footer className="border-t border-[#33291F] py-10 px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-serif text-base tracking-[0.2em] uppercase">ASANUR</span>
          </div>
          <p className="text-xs text-slate-600">© 2026 ASANUR. Your AI-powered wardrobe.</p>
